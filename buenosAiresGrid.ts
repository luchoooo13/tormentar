 ...
 * pronostico gratuito de Open-Meteo (sin API key) en cada punto y estimar donde
...
// Open-Meteo por cada actualizacion; con 2.5 grados de
...
// solo para esta grilla. Open-Meteo es gratuito e ilimitado para uso no
// comercial, asi que este espaciado conservador ya no es obligatorio por el cupo,
// pero mantenerlo reduce el volumen de datos y el consumo.
// Si queres mas resolucion, podes bajar este numero para mas
