...
export default function HistoryScreen() {
  ...
  const { history, loading, refresh, clearHistory, filterBySeverity } =
    useAlertHistory();
  ...
  const handleClear = () => {
    ...
    if (Platform.OS === "web") {
      ...
      if (
        ...
        window.confirm("¿Borrar todo el historial de alertas?")
      ) {
        doClear();
      }
      return;
    ...
    Alert.alert(
      "Borrar historial",
      "¿Borrar todo el historial de alertas? Esta acción no se puede deshacer.",
      [
      ...
      >
        ...
        >
          ...
          <Text className="text-xs text-muted mt-1">
            Alertas que ya finalizaron en tu zona.
          </Text>
        </View>
        ...
        <View className="px-4 py-2 pb-6">
          ...
          {filteredHistory.length > 0 ? (
            ...
            <View
              className="bg-surface p-7 rounded-2xl border items-center"
